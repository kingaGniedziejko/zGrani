        ...
        <div id={"terms-of-service"} className={"page-content"}>
            <Container>
                <Row className={"justify-content-center"}>
                    <Col xs={12} md={11} lg={10} className={"text-justify m-2"}>
                        <h3 className={"mt-5 mb-5 text-center"}>Polityka prywatności</h3>
                        <h5 className={"mb-3 accent-text text-center"}>A. Wprowadzenie</h5>
                        <p className={"mb-5"}>
                            Jest to strona w fazie testowania.
                            Prywatność odwiedzających naszą stronę internetową jest dla nas bardzo ważna i
                            dokładamy wszelkich starań, aby ją chronić. Niniejsza polityka wyjaśnia, co robimy z
                            Twoimi danymi osobowymi. Zgoda na korzystanie z plików cookie zgodnie z warunkami
                            niniejszej polityki podczas pierwszej wizyty na naszej stronie pozwala nam na
                            korzystanie z plików cookie przy każdej kolejnej wizycie na naszej stronie.
                        </p>
                        <h5 className={"mb-3 accent-text text-center"}>B. Źródło</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>C. Zbieranie danych osobowych</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>D. Korzystanie z Twoich danych osobowych</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>E. Ujawnianie danych osobowych</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>F. Międzynarodowe transfery danych</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>G. Zachowywanie danych osobowych</h5>
                        <p className={"mb-5"}>
                            ...
                            typ danych osobowych zostanie usunięty ... ; i ... .
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>H. Bezpieczeństwo danych osobowych</h5>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-3 accent-text text-center"}>K. Strony Internetowe osób trzecich</h5>
                        <p className={"mb-5"}>Nasza strona internetowa zawiera hiperłącza do stron internetowych osób trzecich oraz szczegółowe informacje na ich temat. Nie mamy kontroli i nie ponosimy odpowiedzialności za politykę prywatności i praktyki osób trzecich.</p>
                        <h5 className={"mb-3 accent-text text-center"}>L. Aktualizacja informacji</h5>
                        <p className={"mb-5"}>Prosimy o informację w przypadku konieczności skorygowania lub aktualizowania danych osobowych, w których posiadaniu jesteśmy.</p>
                        <h5 className={"mb-3 accent-text text-center"}>M. Ciasteczka</h5>
                        <p className={"mb-5"}>
