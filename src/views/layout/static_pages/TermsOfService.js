            ...
            <Container>
                <Row className={"justify-content-center"}>
                    <Col xs={12} md={11} lg={10} className={"text-justify m-2"}>
                        <h3 className={"mt-5 mb-5 text-center"}>Regulamin</h3>
                        <h5 className={"mb-1 accent-text text-center"}>§ 1</h5>
                        <h6 className={"mb-3 accent-text text-center"}>Postanowienia wstępne</h6>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-1 accent-text text-center"}>§ 2</h5>
                        <h6 className={"mb-3 accent-text text-center"}>Definicje</h6>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-1 accent-text text-center"}>§ 3</h5>
                        <h6 className={"mb-3 accent-text text-center"}>Wymagania techniczne</h6>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-1 accent-text text-center"}>§ 4</h5>
                        <h6 className={"mb-3 accent-text text-center"}>Zakładanie Konta</h6>
                        <p className={"mb-5"}>
                        ...
                        <h5 className={"mb-1 accent-text text-center"}>§ 5</h5>
                        <h6 className={"mb-3 accent-text text-center"}>Dane osobowe użytkownika</h6>
                        <p className={"mb-5"}>
