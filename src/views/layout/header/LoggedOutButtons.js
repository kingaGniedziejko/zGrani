    ...
    render() {
        return (
            <Nav.Item className="mt-3 mt-md-0 d-flex flex-row">
                <Link to={"/logowanie"} className="mr-2 mt-1 mt-md-0 block" onClick={this.props.hideNavbar}>
                    <Button block variant="outline-white" size="sm">Logowanie</Button>
                </Link>
                <Link to={"/rejestracja"} className="mt-1 mt-md-0 block" onClick={this.props.hideNavbar}>
