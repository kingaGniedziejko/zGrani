...
import MessageForm from "../layout/forms/MessageForm";
        ...
        return (
            <Modal
                ...
                <Modal.Body className={"d-flex flex-row justify-content-center"}>
                    <MessageForm
                        userFrom={{
                            name: (this.props.activeUser.isLoaded && this.props.activeUser.isEmpty)
                                || (!this.props.activeUser.isLoaded && this.props.activeUser.isEmpty)
                                ? "" : this.props.activeUser.name,
                            email: this.props.auth && this.props.auth.isLoaded && this.props.auth.isEmpty
                        ...
                        scrollToTop={this.scrollMessageModalToTop}
                    />
                </Modal.Body>
            </Modal>
        );
