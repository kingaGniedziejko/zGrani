                ...
                <Container>
                    <Row className={"justify-content-center"}>
                        <Col xs={12} md={11} lg={10} className={"text-center m-2"}>
                            <h3 className={"mt-5 mb-5"}>Polityka prywatności</h3>

                            <h5 className={"mb-3 accent-text"}>A. Wprowadzenie</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>B. Źródło</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>C. Zbieranie danych osobowych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>D. Korzystanie z Twoich danych osobowych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>E. Ujawnianie danych osobowych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>F. Międzynarodowe transfery danych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>G. Zachowywanie danych osobowych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>H. Bezpieczeństwo danych osobowych</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>I. Nowelizacje</h5>
                            ...
                            <h5 className={"mb-3 accent-text"}>J. Twoje prawa</h5>
                            <p className={"mb-5"}>
                            ...
                            <h5 className={"mb-3 accent-text"}>K. Strony Internetowe osób trzecich</h5>
                            ...
                            <h5 className={"mb-3 accent-text"}>L. Aktualizacja informacji</h5>
                            ...
                            <h5 className={"mb-3 accent-text"}>M. Ciasteczka</h5>
                            <p className={"mb-5"}>
